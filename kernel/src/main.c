...
__attribute__((used, section(".requests_start_"
	...
	__attribute__((used, section(".requests"))) volatile struct limine_memmap_request memmap_request = {
		...
		.revision = 2};
__attribute__((used, section(".requests"))) volatile struct limine_hhdm_request hhdm_request = {.id =
																									LIMINE_HHDM_REQUEST,
																								.revision = 2};
__attribute__((used, section(".requests"))) volatile struct limine_mp_request smp_request = {.id = LIMINE_MP_REQUEST,
																							 .revision = 2};
__attribute__((used, section(".requests"))) volatile struct limine_executable_address_request kernel_address = {
	.id = LIMINE_EXECUTABLE_ADDRESS_REQUEST,
	.revision = 2};
__attribute__((used, section(".requests"))) volatile struct limine_rsdp_request rsdp_request = {.id =
																									LIMINE_RSDP_REQUEST,
																								.revision = 2};
