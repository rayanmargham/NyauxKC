...
struct arch_per_cpu_data
{
	...
	uint64_t kernel_stack_ptr;	  // this has to get updated when switching threads. its just indirection, so its easier
								  // for the cpu to get the kernel stack for syscall
